...
class DepartmentSerializer(serializers.ModelSerializer):
   ...
   class Meta:
       model = Department
       fields = ['id', 'name', 'college', 'college_name', 'created_at', 'updated_at']
       read_only_fields = ['created_at', 'updated_at']
...
class FacultySerializer(serializers.ModelSerializer):
   ...
   class Meta:
       model = Faculty
       fields = [
           'id', 'employee_number', 'last_name', 'first_name', 'middle_initial',
           'birthdate', 'gender', 'department', 'department_name',
           'region_code', 'province_code', 'city_municipality_code',
           'barangay_code', 'street_address', 'email', 'phone', 'photo',
...
class AttendanceRecordSerializer(serializers.ModelSerializer):
   ...
   class Meta:
       ...
       fields = [
           'id', 'faculty', 'faculty_last_name', 'faculty_employee_number',
           'seminar', 'seminar_title', 'time_logged',
       ]
