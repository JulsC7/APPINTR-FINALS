...
async function fetchFaculty() {
    try {
        ...
        document.getElementById('faculty-message').innerText = "Error loading data. Is your Django server running?";
        document.getElementById('faculty-message').classList.replace('text-blue-500', 'text-red-500');
    }
}
...
async function fetchAttendance() {
    try {
        ...
        document.getElementById('attendance-message').innerText = "Error loading data. Is your Django server running?";
        document.getElementById('attendance-message').classList.replace('text-blue-500', 'text-red-500');
    }
}
